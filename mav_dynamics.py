...
mav_dynamics.py: class file for dynamics of mav
    ...
    - History:
        ...
        - 11/22: Adding functionality for MF PD LQR Algo (accepts inital states)

"""

import numpy as np
from helper import QuaternionToEuler, QuaternionToRotationMatrix, EulerToQuaternion
...
class MAV_Dynamics:
    ...
    def __init__(self, time_step, init_state):
        ...
        self.internal_state[0] = init_state.north
        self.internal_state[1] = init_state.east #MAV_para.east0
        self.internal_state[2] = -init_state.altitude #MAV_para.down0
        self.internal_state[3] = tmp.item(0) #MAV_para.u0
        self.internal_state[4] = tmp.item(1) #MAV_para.v0
        self.internal_state[5] = tmp.item(2) #MAV_para.w0
        self.internal_state[6] = e_quat.item(0) #MAV_para.e0
        self.internal_state[7] = e_quat.item(1) #MAV_para.e1
        self.internal_state[8] = e_quat.item(2) #MAV_para.e2
        self.internal_state[9] = e_quat.item(3) #MAV_para.e3
        self.internal_state[10] = init_state.p #MAV_para.p0
        self.internal_state[11] = init_state.q #MAV_para.q0
        self.internal_state[12] = init_state.r #MAV_para.r0
